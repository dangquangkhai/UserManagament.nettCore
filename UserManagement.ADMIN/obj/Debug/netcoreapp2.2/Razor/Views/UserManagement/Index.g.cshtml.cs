#pragma checksum "/home/khai/Projects/Dotnet-Core/Web-App/UserManagement/UserManagement.ADMIN/Views/UserManagement/Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "cee3e333f25b9bfd10d07973811df8a0c35c85be"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"cee3e333f25b9bfd10d07973811df8a0c35c85be", @"/Views/UserManagement/Index.cshtml")]
...
<script src=""https://cdn.datatables.net/buttons/1.2.2/js/bu");
...
<script>
  var AppUser = new Vue({
    ...
    updated() {
      ...
      $(""#main"").dataTabl");
            WriteLiteral(@"e.ext.errMode = ""none"";
    },
    mounted() {
      $(""#main"").dataTable({
        pagingType: ""full_numbers"",
    ...
    methods: {
      GetLstUsr: function () {
     ");
            WriteLiteral(@"   axios.get(API_BASE_URL + ""UserManagement/GetAllUsr"").then(response => {
